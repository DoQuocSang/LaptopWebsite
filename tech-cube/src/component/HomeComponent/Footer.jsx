...
export default function Footer() {
  ...
  return (
    <>
      <Box w={'100%'} borderTop="1px solid lightgray" mt="20px"></Box>
      <Box
          ...
          >
            ...
            >
              <Stack direction={'column'} pl={5}>
                ...
                <Text fontSize={25} fontWeight={'bolder'}>
                ...
                <HStack>
                  <Link>
                    <IconButton
                      borderRadius={'50%'}
                      border={
                        text === 'dark' ? '2px solid white' : '2px solid black'
                      }
                      variant={'outline'}
                      color={textColor}
                      icon={<FaInstagram />}
      ...
      <Box w={'100%'}>
        <Center>
          <Stack direction={'column'} py={50}>
            <Center>
              <Text fontSize={16}>THANH TOÁN AN TOÀN 100%</Text>
            </Center>

            <Grid
              direction={{ base: 'column', md: 'row' }}
              templateColumns={{ base: 'repeat(3,1fr)', md: 'repeat(8,1fr)' }}
              gap={'15px'}
              p="15px"
            >
              <Image
