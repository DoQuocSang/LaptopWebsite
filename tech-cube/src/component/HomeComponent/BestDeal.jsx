...
const imageArr = [
  {
    ...
    text: 'APPLE A715-42G-R2NE l',
    price: 500,
    description: 'Key Features 39.6cm (15.6")',
    id: 97,
    disc: 53,
  },
  {
    image:
      'https://cdn.shopify.com/s/files/1/0057/8938/4802/products/Untblueitled-1_600x.png?v=1661509030',
    text: 'Wireless_Headphone',
    price: 300,
  ...
  {
    image:
      'https://cdn.shopify.com/s/files/1/0057/8938/4802/products/WaveFlexConnectPackaging1.2_300x.png?v=1677645513',
    text: 'Wave Select Smartwatch',
    price: 800,
    description: '1.78" AMOLED Display',
    id: 15,
    disc: 75,
  },
];
          ...
          {imageArr.map((el, ind) => (
            ...
            >
              ...
              <Stack px="5px">
                ...
                <Flex
                  gap="20px"
                  color={text === 'dark' ? 'white' : 'blackAlpha.900'}
                >
                  <Text fontWeight={'bold'} color={textColor} fontSize={'18px'}>
                    {el.price}VNĐ
                  </Text>
                  <Text fontWeight={'bold'} color={'green'} fontSize={'18px'}>
                    {el.disc}% off
                  </Text>
                </Flex>
