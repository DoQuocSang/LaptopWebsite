        ...
        >
          ...
          >
            <Heading as={'h2'} fontSize={'23px'}>
              Xem xét hình thức và vận chuyển
            </Heading>
            {data.length === 0 ? (
              <Alert m={'20px 0'} p={'30px'} status="warning">
                <AlertIcon ml={'240px'} />
...
export const CheckoutPrice = ({ text }) => {
  ...
  return (
    ...
    >
      ...
      <Heading textAlign={'center'} as={'h2'} fontSize={'23px'}>
        Danh sách
      </Heading>
      ...
      <Box lineHeight={'35px'}>
        ...
        <Flex justifyContent={'space-between'}>
          ...
          <Text>
            {cartPrice > 500 ? 'FREE' : cartPrice === 0 ? `$ ${0}` : `$ ${40}`}
          </Text>
        </Flex>
        <Flex justifyContent={'space-between'}>
          <Text>Thuế 18%</Text>
      ...
      <Box>
        <Flex justifyContent={'space-between'}>
          ...
          <Heading size={'md'}>
            ${' '}
            {promoCodeStatus
              ? (cartPrice + cartPrice * 0.18 - cartPrice * 0.1).toFixed(2)
              : (cartPrice + cartPrice * 0.18).toFixed(2)}
          </Heading>
        </Flex>
      </Box>
      <Box m={'10px 0'} h={'3px'} color={'gray.600'}>
